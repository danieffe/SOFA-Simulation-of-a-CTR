...
def createScene(rootNode):
    ...
    surface_mesh.addObject('MeshOBJLoader', name='loader', filename="C:\SOFA_v25.06.00_Win64\plugins\ModelOrderReduction\share\sofa\examples\ModelOrderReduction\others\caduceus\mesh\snake_body.obj")
