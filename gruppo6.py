...
def createScene(rootNode):
    ...
    heart.addObject('MeshOBJLoader', name="heartLoader", filename=os.path.join(meshpath, 'heart.obj'), translation="0 -50 50", scale="10")
    ...
    heart.addObject('UniformMass', name="mass", totalMass="1.0")
    ...
    heart.addObject('BoxROI', name="fixedBox", box="10 -1 0 50 60 90", drawBoxes="1")
    heart.addObject('FixedProjectiveConstraint', indices="@fixedBox.indices")
